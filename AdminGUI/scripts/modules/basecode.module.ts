...
import { MenuComponent, CheckboxWrapperControl, CheckboxJqueryControl, DatePickerWrapperControl, DatePickerJqueryControl, TextboxWrapperControl, DropdownJqueryControl, DropDownWrapperControl, SuperTextboxJqueryControl, SuperTextboxWrapperControl, DropDownAndLookupWrapperControl, LookupJqueryControl, DropDownAndAutoCompleteExtendedWrapperControl, AutocompleteExtendedJqueryControl} from 'basecode/controls';
...
import { GridPrimeControl, WrapperPipe, HighlightDirective } from 'basecode/controls';
...
@NgModule({
    ...
    declarations: [MenuComponent, LoginComponent, Growl, GenericFormComponent, GridPrimeControl, BusyOverlayComponent, PlaceholderComponent, WrapperPipe,
        ...
        DropDownWrapperControl, HighlightDirective, LookupJqueryControl, SuperTextboxJqueryControl, SuperTextboxWrapperControl, DropDownAndLookupWrapperControl, DropDownAndAutoCompleteExtendedWrapperControl, AutocompleteExtendedJqueryControl],
    ...
    entryComponents: [DropDownWrapperControl, TextboxWrapperControl, DatePickerWrapperControl, CheckboxWrapperControl, SuperTextboxWrapperControl,
        DropDownAndLookupWrapperControl, GenericFormComponent, DropDownAndAutoCompleteExtendedWrapperControl ]
})
